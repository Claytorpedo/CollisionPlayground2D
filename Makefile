...
SRCDIRS := $(TOPDIR)/CollisionPlayground2D $(TOPDIR)/CollisionPlayground2D/geom_examples
...
GEOM := $(TOPDIR)/External/Geometry2D
...
INCL_DIRS := `pkg-config --cflags sdl2` -I $(TOPDIR)/External
